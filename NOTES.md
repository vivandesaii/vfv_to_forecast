...
## June 17: FINAL 
- GARCH(1,1) conditional vol replaces rolling_vol as HMM feature
- Features: daily_return, garch_vol, vol_ratio, vix
- Sharpe: 2.5345 > vanilla 2.3211 (+9% risk-adjusted)
- XIRR:   23.46% = vanilla exactly
- Drawdown: -3.42% vs vanilla -2.93%
- GARCH works because it detects vol regime changes faster
- rolling_vol + garch_vol together = redundant, worse results